...
public class DayNightController : MonoBehaviour {
	...
	void CalculateTime (){
		...
		timeString = day + " J " + Mathf.Floor(currentTime).ToString() + " : " + minutes.ToString("F0") + " "+AMPM ;
		if (minutes > 9)
		{
			if (currentTime > 9)
			{
				heure.text = day + " J " + Mathf.Floor(currentTime).ToString() + " : " + minutes.ToString("F0");
			}
			else
            {
				heure.text = day + " J 0" + Mathf.Floor(currentTime).ToString() + " : " + minutes.ToString("F0");
			}
		}
        else
        {
			if (currentTime > 9)
			{
				heure.text = day + " J " + Mathf.Floor(currentTime).ToString() + " : 0" + minutes.ToString("F0");
			}
			else
			{
				heure.text = day + " J 0" + Mathf.Floor(currentTime).ToString() + " : 0" + minutes.ToString("F0");
			}
		}
